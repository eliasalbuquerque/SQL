...
INSERT INTO company.customers (customerNumber,customerName,contactLastName,contactFirstName,phone,addressLine1,addressLine2,city,state,postalCode,country,salesRepEmployeeNumber,creditLimit)
VALUES(498,'Loja de Esportexs','Doug','Jeff','33-99885-6895','Rua Roberto Campos','casa 2','Porto Alegre','RS','335896','Brazil',1165,65000);
...
INSERT INTO company.products (productCode, productName, productLine, productScale, productVendor, productDescription, quantityInStock, buyPrice, MSRP)
VALUES ('S10_1809', '1969 Harley Davidson Ultimate Chopper', 'Motorcycles', '1:10', 'Min Lin Diecast', 'This replica features working kickstand, front suspension, gear-shift lever, footbrake lever, drive chain, wheels and steering. All parts are particularly delicate due to their precise scale and require special care and attention.', 7933, 5, 95.70);
    ...
    IF NEW.creditLimit > OLD.creditLimit THEN
        ...
        VALUES (
            NEW.customerNumber, CONCAT(
                'Limite de crédito aumentado de: ', OLD.creditLimit, ' para: ', NEW.creditLimit
            ), NOW()
        );
    END IF;
END;
...
BEGIN
    IF NEW.buyPrice <> OLD.buyPrice THEN
        ...
        VALUES(
            ...
            NOW(),
            CONCAT(
                'O preço do produto ',NEW.productCode,' mudou de ',OLD.buyPrice,' para ',NEW.buyPrice,'.'
            )
        );
    END IF;
END;
